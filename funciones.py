...
def anadir(frameMostrar,archivo, tabla_actual):
    ...
    #Titulo
    titulo= Label(window, text=f"Añadir a la tabla {tabla_actual}",fg="black",font=("Comic Sans", 13,"bold"),pady=5).pack()
    ...
    boton_cancelar=Button(frame_botones,text="CERRAR",command=window.destroy ,height=2,width=10,bg="red",fg="white",font=("Comic Sans", 10,"bold")).grid(row=0, column=3, padx=10, pady=15)
    #window.geometry('390')
